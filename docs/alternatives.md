...
1. [caselib](https://pypi.org/project/caselib) — <i class="fab fa-github"></i> [sublee/caselib](https://github.com/sublee/caselib)
...
1. [python-string-utils](https://pypi.org/project/python-string-utils) — <i class="fab fa-github"></i> [daveoncode/python-string-utils](https://github.com/daveoncode/python-string-utils)
...
#### Not publicly maintained (no commits in last 2 years)

1. [boa-str](https://pypi.org/project/boa-str) — source repository not found
1. [camel-case-switcher](https://pypi.org/project/camel-case-switcher) — source repository not found
1. [camel_snake_kebab](https://pypi.org/project/camel_snake_kebab) — source repository not found
1. [camelcase-coverter](https://pypi.org/project/camelcase-coverter) — source repository not found
1. [camelcase](https://pypi.org/project/camelcase) — source repository not found
1. [camely](https://pypi.org/project/camely) — source repository not found
1. [case-changer](https://pypi.org/project/case-changer) — source repository not found — <i class="fa fa-book"></i> [python-case-changer.readthedocs.io](https://python-case-changer.readthedocs.io)
1. [casec](https://pypi.org/project/casec) — source repository not found
1. [casing](https://pypi.org/project/casing) — source repository not found
1. [cassidy](https://pypi.org/project/cassidy) — source repository not found
1. [codecaseconverter](https://pypi.org/project/codecaseconverter) — source repository not found
1. [convert-case-py](https://pypi.org/project/convert-case-py) — source repository not found
1. [dxf](https://pypi.org/project/dxh) — source repository not found
1. [humpy](https://pypi.org/project/humpy) — source repository not found
1. [namae](https://pypi.org/project/namae) — source repository not found
1. [omniblack.string-case](https://pypi.org/project/omniblack.string-case) — source repository not found
1. [raptorstr](https://pypi.org/project/raptorstr) — source repository not found
1. [silex](https://pypi.org/project/silex) — source repository not found
1. [snake-and-camel](https://pypi.org/project/snake-and-camel) — source repository not found
1. [snake-case](https://pypi.org/project/snake-case) — source repository not found
1. [snakecase](https://pypi.org/project/snakecase) — source repository not found
1. [stringbender](https://pypi.org/project/stringbender) — source repository not found

### Non-PyPI packages

1. animal_case — <i class="fab fa-github"></i> [rafa-acioly/animal_case](https://github.com/rafa-acioly/animal_case)
1. case_converter — <i class="fab fa-github"></i> [ecly/case_converter](https://github.com/ecly/case_converter)
...
* [https://github.com/topics/camelcase?l=python]()
